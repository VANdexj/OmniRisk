...
class LatticeParam:
    def __init__(self):
        ...
        self.vertical_center = cfg["vertical_center_deg"] / 180.0 * torch.pi  # center of the vertical anchor band
        ...
        for h in range(0, self.radio_num):
            for i in range(0, self.vertical_num):
                for j in range(0, self.horizon_num):
                    ...
                    beta = torch.tensor(self.vertical_center - altitude_diff * (self.vertical_num - 1) / 2 + i * altitude_diff)
