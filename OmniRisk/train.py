...
import argparse
import numpy as np
from policy.trainer import OmniRiskTrainer
...
if __name__ == "__main__":
    ...
    checkpoint_path = log_dir + "/run_{}/epoch{}.pth".format(args.trial, args.epoch) if args.pretrained else ""

    trainer = OmniRiskTrainer(
    ...
    trainer.train(epoch=200, save_interval=30)
