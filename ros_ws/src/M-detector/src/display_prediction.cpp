...
int main(int argc, char** argv)
{
    ...
    {
        ROS_ERROR("dyn_obj/pred_file is empty. Please pass the folder containing .label files.");
        return 1;
    }
    ...
    if (pred_dir == NULL)
    {
        ROS_ERROR_STREAM("Failed to open dyn_obj/pred_file directory: " << pred_folder);
        return 1;
    }
